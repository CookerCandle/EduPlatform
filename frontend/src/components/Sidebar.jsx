...
import { Home, BookOpen, Calendar, Pencil, Settings, LogOut, Bot } from 'lucide-react';

import { useNavigate, useLocation } from 'react-router-dom';

const navItems = [
  { id: 'home', icon: Home, label: 'Journal', color: '#FF8A80', path: '/home' },
  { id: 'courses', icon: BookOpen, label: 'Courses', color: '#82B1FF', path: '/courses' },
  { id: 'schedule', icon: Calendar, label: 'Schedule', color: '#FFD54F', path: '/schedule' },
  { id: 'ai', icon: Bot, label: 'AI', color: '#d414c1ff', path: '/ai' }
];
